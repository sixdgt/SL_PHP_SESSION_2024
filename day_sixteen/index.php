            ...
            <?php
                ...
                foreach ($users as $user) {
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo "/".$user['profile_pic']; ?>" 
                        alt='Profile Picture' width='100' height="100"></td>
                        <!-- <td><a href='delete_user.php?user_id=<?php echo $user['id']; ?>'>Delete</a></td> -->
                    </tr>
                    <?php
                    $counter++;
                }
