...
function sendEmail($sender, $receiver, $verification_code){
    ...
    try{
        ...
        $mail->Subject = 'User Verification | PHP SL 024'; // mail subject
        $mail->Body = "Your accont has been created successfully. 
        Your verification code is <strong>$verification_code</strong>"; // mail body
        $mail->send();
